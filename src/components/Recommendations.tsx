...
const Recommendations = () => {
    ...
    return (
        <div className="container mx-auto flex flex-col flex-wrap justify-center items-center">
            ...
            <div className="text-4xl font-bold tracking-tight text-center text-grey p-4">what do my mentors say</div>
            <div className="m-5 p-4 bg-card border border-grey rounded-lg shadow">
                <div className="mb-3 p-3 text-lg tracking-tight font-normal overflow-hidden">{recommendations.content}</div>
